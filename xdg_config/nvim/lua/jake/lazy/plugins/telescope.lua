...
return {
  ...
  keys = {
    ...
    {"<leader>fd", function() require("telescope.find_folders").find_folders() end, desc = "[f]ind [d]irectory"},
    ...
    {"<leader>fws", function() require("telescope.builtin").lsp_workspace_symbols() end, desc = "[f]ind [w]orkspace [s]ymbols" },
  },
  config = function()
    ...
    require("telescope.find_folders").setup()
