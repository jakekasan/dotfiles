...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME=jake
...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/jw/_6s4jtzx11qf1zzvb8z5rym80000gn/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/jakekasan/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/jakekasan/.mailcheckrc"
# }
